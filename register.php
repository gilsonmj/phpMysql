                        ...
                        <form id="form-register">
                            <div class="form-row mb-4">
                                <div class="col-sm-12 col-md-12">
                                    ...
                                    <input class="form-control" type="text" id="name" name="nome" minlength="4" required="" placeholder="Digite aqui">
                                </div>
                            </div>
                            <div class="form-row mb-4">
                                <div class="col-sm-12 col-md-12">
                                    <label class="text-orange"><b>E-mail*</b></label>
                                    <input class="form-control" type="email" name="email" minlength="4" required="" placeholder="Digite aqui seu e-mail.">
                                </div>
                            </div>
